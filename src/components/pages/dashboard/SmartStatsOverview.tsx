...
export function SmartStatsOverview({ userType, userData }: SmartStatsOverviewProps) {
        ...
        <CardHeader className="relative flex flex-row items-center justify-between pb-2">
          ...
          <div className="flex items-center space-x-1">
            ...
            {onAIClick && (
              <button
                onClick={onAIClick}
                className="p-1.5 rounded-lg hover:bg-white/30 dark:hover:bg-white/10 transition-all duration-200 group/ai"
                title="AI智能分析"
              >
                <span className="text-sm group-hover/ai:scale-110 transition-transform duration-200">🤖</span>
              </button>
            )}
          </div>
        </CardHeader>
  ...
  const PackageUsageCard = () => (
    <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-gradient-to-br from-indigo-50/80 to-purple-50/80 dark:from-indigo-950/40 dark:to-purple-950/40 backdrop-blur-sm">
      {/* 装饰性背景元素 */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full -translate-y-8 translate-x-8"></div>
        <div className="absolute bottom-0 left-0 w-12 h-12 bg-gradient-to-tr from-indigo-500 to-purple-600 rounded-full translate-y-4 -translate-x-4"></div>
      </div>
      ...
      <CardContent className="relative pt-0 space-y-3">
        <div>
          ...
          <div className="w-full bg-gray-200/80 rounded-full h-2.5 dark:bg-gray-700/80 shadow-inner">
            <div 
              className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-2.5 rounded-full transition-all duration-1000 shadow-lg relative overflow-hidden"
        ...
        <div className="space-y-2">
          {/* Token使用情况 - 紧凑版 */}
          <div className="bg-white/60 dark:bg-gray-700/40 rounded-lg p-3 border border-gray-200/50 dark:border-gray-600/50">
            ...
            <div className="w-full bg-gray-200/80 rounded-full h-1.5 dark:bg-gray-700/80 shadow-inner">
              <div 
                className="bg-gradient-to-r from-blue-500 to-cyan-500 h-1.5 rounded-full transition-all duration-700 shadow-sm"
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 flex justify-between">
              ...
              <span className="font-medium">
                剩余{mockStats.packageUsage.daysLeft.tokens}天
              </span>
            </div>
          </div>
          ...
          <div className="bg-white/60 dark:bg-gray-700/40 rounded-lg p-3 border border-gray-200/50 dark:border-gray-600/50">
            ...
            <div className="w-full bg-gray-200/80 rounded-full h-1.5 dark:bg-gray-700/80 shadow-inner">
              <div 
                className="bg-gradient-to-r from-green-500 to-emerald-500 h-1.5 rounded-full transition-all duration-700 shadow-sm"
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 flex justify-between">
              ...
              <span className="font-medium">
                剩余{mockStats.packageUsage.daysLeft.plugins}天
              </span>
            </div>
          </div>
        </div>
        ...
        {showAIAnalysis === 'package' && (
          <div className="bg-gradient-to-r from-blue-50/90 to-indigo-50/90 dark:from-blue-950/40 dark:to-indigo-950/40 rounded-lg p-3 border border-blue-200/50 dark:border-blue-700/50 backdrop-blur-sm">
            <div className="flex items-start space-x-2">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-0.5 text-xs text-blue-700 dark:text-blue-300 mb-2">
                ...
                <div className="flex gap-2">
                  <Button size="sm" variant="outline" className="h-6 text-xs px-2 border-blue-300 text-blue-700 hover:bg-blue-100 dark:border-blue-600 dark:text-blue-300">
                    查看分析
                  </Button>
                  <Button size="sm" variant="outline" className="h-6 text-xs px-2 border-blue-300 text-blue-700 hover:bg-blue-100 dark:border-blue-600 dark:text-blue-300">
                    优化方案
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="text-xs text-gray-500 dark:text-gray-400 bg-white/60 dark:bg-gray-800/60 px-2 py-1 rounded-lg backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50">
            🤖 AI智能预测
          </div>
          <Badge variant="secondary" className="bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 text-xs font-medium px-2 py-1">
            实时数据
          </Badge>
        </div>
      </div>
          ...
          <CardContent>
            <div className="text-sm text-gray-700 dark:text-gray-300">
              ...
              {showAIAnalysis === 'dau' && (
                <div>
                  <ul className="space-y-1 text-xs">
                    <li>• DAU增长趋势良好，用户粘性提升</li>
                    <li>• 工作日使用峰值在上午10-12点</li>
                    <li>• 建议在高峰期前预热系统资源</li>
                  </ul>
                </div>
              )}
